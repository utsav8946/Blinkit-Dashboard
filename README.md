...
**Features / Highlights**
📊 Overall Performance KPIs – total sales, total orders, average rating, and more
🛒 Category-wise Analysis – understand which product categories perform the best
🏪 Outlet Insights – sales comparison between different outlet types and locations
⭐ Customer Rating Analysis – track customer satisfaction trends
📅 Filter & Slicer Options – interact with the data by category, outlet, rating, and time
